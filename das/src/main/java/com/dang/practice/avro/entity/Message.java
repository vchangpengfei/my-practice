...
public class Message extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1351996856990183025L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Message\",\"namespace\":\"com.dang.practice.avro.entity\",\"fields\":[{\"name\":\"to\",\"type\":\"string\"},{\"name\":\"from\",\"type\":\"string\"},{\"name\":\"body\",\"type\":\"string\"}]}");
   ...
   */
  public static com.dang.practice.avro.entity.Message.Builder newBuilder() {
    return new com.dang.practice.avro.entity.Message.Builder();
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static com.dang.practice.avro.entity.Message.Builder newBuilder(com.dang.practice.avro.entity.Message.Builder other) {
    return new com.dang.practice.avro.entity.Message.Builder(other);
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static com.dang.practice.avro.entity.Message.Builder newBuilder(com.dang.practice.avro.entity.Message other) {
    return new com.dang.practice.avro.entity.Message.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Message>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.dang.practice.avro.entity.Message.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.dang.practice.avro.entity.Message other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.to)) {
        this.to = data().deepCopy(fields()[0].schema(), other.to);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dang.practice.avro.entity.Message.Builder setTo(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dang.practice.avro.entity.Message.Builder clearTo() {
      to = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dang.practice.avro.entity.Message.Builder setFrom(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dang.practice.avro.entity.Message.Builder clearFrom() {
      from = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dang.practice.avro.entity.Message.Builder setBody(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dang.practice.avro.entity.Message.Builder clearBody() {
      body = null;
